...
class TestSwiftMetalPlatform:
    def test_is_available_on_apple_silicon(self):
        from vllm_swift_metal.platform import SwiftMetalPlatform
    ...
    def test_not_available_on_x86(self):
        ...
        with patch("vllm_swift_metal.platform.py_platform") as mock_plat:
    ...
    def test_check_and_update_config(self):
        ...
        assert vllm_config.parallel_config.worker_cls == (
            "vllm_swift_metal.worker.SwiftMetalWorker"
        )
...
class TestPlatformPlugin:
    ...
    def test_register_returns_none_on_unsupported(self):
        ...
        with patch(
            "vllm_swift_metal.platform.SwiftMetalPlatform.is_available", return_value=False
        ):
